...
class File(models.Model):
    ...
    file_path = models.CharField(verbose_name='File Path', max_length=255, null=True,
                                 blank=True)  # the location of the file on the tencent cos server
    parent = models.ForeignKey(to='self', verbose_name='Parent Folder', on_delete=models.CASCADE, null=True, blank=True,
...
class Issues(models.Model):
    ...
    assign = models.ForeignKey(to='UserInfo', verbose_name='Assign to', on_delete=models.CASCADE, related_name='task',
    ...
    parent = models.ForeignKey(to='self', verbose_name='Parent Issue', on_delete=models.CASCADE, null=True, blank=True,
                               related_name='children')
...
class ProjectInvite(models.Model):
    """Project invite"""
    project = models.ForeignKey(to='Project', verbose_name='Project', on_delete=models.CASCADE)
    creator = models.ForeignKey(to='UserInfo', verbose_name='Creator', related_name='create_invite',
                                on_delete=models.CASCADE)
    code = models.CharField(verbose_name='Invite Code', max_length=64, unique=True)
    count = models.PositiveIntegerField(verbose_name='Number Limit', null=True, blank=True, help_text='Empty means '
                                                                                                     'unlimited')
    use_count = models.PositiveIntegerField(verbose_name='Invited Count', default=0)
    period_choices = (
        (30, '30 Minutes'),
        (60, '1 Hour'),
        (300, '5 Hours'),
