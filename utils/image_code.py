...
font_path = Path(__file__).parent.parent / 'kumo.ttf'


def generate_image_code(width=140, height=40, char_length=5, font_file=str(font_path), font_size=28):
    ...
    Args:
        ...
        char_length (int, optional): the length of verify code. Defaults to 5.
